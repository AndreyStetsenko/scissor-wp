		...
		<div class="col-md-6">
			...
			<form action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
				<div class="cart-title">
					...
					<span class="caption">Проверьте свой заказ, чтобы получить квалифицированное обслуживание</span>
				</div>
					...
					<div class="item">
						...
						<?php
									echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
										...
										sprintf(
											'<a href="%s" class="btn btn-black" aria-label="%s" data-product_id="%s" data-product_sku="%s">Удалить</a>',
				...
				<a href="<?= get_permalink( wc_get_page_id( 'shop' ) ) ?>" class="btn btn-black mt-3">Продолжить покупку</a>
			</form>
